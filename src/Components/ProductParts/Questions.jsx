...
const Questions = component$(({
    ...
    return <div>
        ...
        <div class="mt-10">
            {
                questions?.slice(0, numberSlice.value).map(question => <>
                    <div
                        class="border rounded-lg p-4 bg-custom-color2"
                        key={question.id}
                    >
                        ...
                        </div>
                        {
                            ...
                            <div class="ms-8 px-4 border rounded-lg">
                                {
            ...
            {
                questions.length > numberSlice.value &&
                <button
