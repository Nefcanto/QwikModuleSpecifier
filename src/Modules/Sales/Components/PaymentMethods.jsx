                        ...
                        >
                            <label class="text-sm font-bold text-gray-900 block flex items-start gap-2">
                                <input
                                    ...
                                    value={item.key}
                                    onInput$={e => {
                                        const selectedPaymentMethod = paymentMethods.find(i => i.key == e.target.value)
                                        packageModel.paymentMethodKey = selectedPaymentMethod.key
                                        packageModel.paymentMethodGuid = selectedPaymentMethod.guid
                                    }}
                                />
