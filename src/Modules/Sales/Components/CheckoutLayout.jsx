                        ...
                        <div class="bg-gray-200/60 p-3 py-4 mt-2">
                            <div class="flex justify-between mt-2">
                                ...
                                <span class="flex gap-0.5 items-center">
                                    <span class="text-sm">{cart?.order?.pricingPriceAmount?.toLocaleString()}</span>
                            ...
                            {/* <div class="flex justify-between mt-2">
                                <span class="text-sm">{factorStatics.discount}</span>
                                <span class="flex gap-0.5 items-center">
                                    <span class="text-sm">DiscountAmount</span>
                                    <span class="text-xs text-gray-400">DiscountCurrency</span>
                                </span>
                            </div> */}
                            <div class="flex justify-between mt-2">
                            ...
                            {/* <div class="flex mt-4">
                                <input
                                    type="text"
                                    class="self-stretch text-xs p-1 grow outline-none"
                                    placeholder={factorStatics?.couponPlaceholder}Coupon
                                />
                                <button
                                    // onClick$={}
                                    type="button"
                                    class="text-xs bg-gray-700 text-white p-1 py-2"
                                >{factorStatics.couponButtonTitle}</button>
                            </div> */}
                        </div>
